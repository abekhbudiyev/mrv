...
const props = { pageKey: 'applications-list' } as const
...
const isApplicationsListPage = computed(() => true)
const isIptkApplicationsListPage = computed(() => true)
    ...
    <div class="relative flex min-h-0 min-w-0 max-w-full flex-1 flex-col xl:min-h-0">
      ...
      >
        <template v-if="isApplicationsListPage">
          ...
          <StatusTabs
            v-if="isIptkApplicationsListPage"
            :tabs="applicationStepTabs"
            :selected-values="appliedStepFilter"
            item-key-prefix="application-step-tab"
            @select="selectApplicationStepTab($event as ApplicationStepTabValue)"
          />
