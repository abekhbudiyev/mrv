  ...
  'children-questionnaires': [
    {
      ...
      metadata: [
        { label: 'Xizmatdan foydalanuvchi FIO', value: 'Saidov Azizbek Akmal o‘g‘li' },
        { label: 'Xizmatdan foydalanuvchi JSHSHIR', value: '51201876543210' },
        { label: 'Ariza beruvchi FIO', value: 'Saidova Nargiza Akmalovna' },
        { label: 'Ariza beruvchi JSHSHIR', value: '41201876543211' },
        { label: 'Tadbirkor', value: 'Mehrli Qadam MCHJ' },
        { label: 'INN', value: '309845672' },
    ...
    },
    {
      ...
      metadata: [
        { label: 'Xizmatdan foydalanuvchi FIO', value: 'Karimova Madina Dilshod qizi' },
        { label: 'Xizmatdan foydalanuvchi JSHSHIR', value: '51302876543212' },
        { label: 'Ariza beruvchi FIO', value: 'Karimov Dilshod Bahrom o‘g‘li' },
        { label: 'Ariza beruvchi JSHSHIR', value: '41302876543213' },
        { label: 'Tadbirkor', value: 'Yuksalish Bolalar Markazi' },
        { label: 'INN', value: '301582746' },
  ...
  'children-vouchers': [
    {
      ...
      submittedAt: '2026-06-20',
      dueAt: '2026-07-20',
      nextAction: 'Vaucherni tahrirlash yoki yuborish',
      summary: 'Vaucher yaratildi va xizmat ko‘rsatuvchi tashkilotga yuborishga tayyor.',
      metadata: [
        { label: 'Xizmatdan foydalanuvchi FIO', value: 'Karimova Madina Dilshod qizi' },
        { label: 'Xizmatdan foydalanuvchi JSHSHIR', value: '51302876543212' },
        { label: 'Ariza beruvchi FIO', value: 'Karimov Dilshod Bahrom o‘g‘li' },
    ...
    },
    {
      ...
      metadata: [
        { label: 'Xizmatdan foydalanuvchi FIO', value: 'Nazarov Diyorbek Dilshod o‘g‘li' },
        { label: 'Xizmatdan foydalanuvchi JSHSHIR', value: '51403876543214' },
        { label: 'Ariza beruvchi FIO', value: 'Nazarova Shahnoza Ilhomovna' },
        { label: 'Ariza beruvchi JSHSHIR', value: '41403876543215' },
        { label: 'Tadbirkor', value: 'Imkon Terapiya NNT' },
        { label: 'INN', value: '305914628' },
...
const eiRequiredStatusSamplesByPageKey: Record<string, EiStatusSample[]> = {
  ...
  'children-vouchers': [
    { status: 'Yaratilgan', tone: 'info', nextAction: 'Vaucherni tahrirlash yoki yuborish' },
    { status: 'O‘zgartirilgan', tone: 'warning', nextAction: 'O‘zgartirilgan vaucherni yuborish' },
    { status: 'Yuborilgan', tone: 'warning', nextAction: 'Xizmat ko‘rsatuvchi qarorini kutish' },
    { status: 'Qabul qilingan', tone: 'success', nextAction: 'Buyurtma shakllantirish' },
    { status: 'Rad etilgan', tone: 'danger', nextAction: 'Rad etish sababini xabarnoma qilish' },
  ...
  'children-orders': [
    { status: 'Yaratilgan', tone: 'info', nextAction: 'Buyurtmani tahrirlash yoki yuborish' },
    { status: 'O‘zgartirilgan', tone: 'warning', nextAction: 'O‘zgartirilgan buyurtmani yuborish' },
    { status: 'Yuborilgan', tone: 'warning', nextAction: 'Xizmat ko‘rsatuvchi qarorini kutish' },
    { status: 'Qabul qilingan', tone: 'success', nextAction: 'Erta aralashuv rejasini ishlab chiqish' },
    { status: 'Rad etilgan', tone: 'danger', nextAction: 'Rad etish sababini xabarnoma qilish' },
  ],
  'service-active': [
