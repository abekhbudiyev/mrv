...
<template>
  <div class="min-h-screen overflow-x-hidden bg-background text-foreground xl:h-screen xl:overflow-hidden">
    <div
      ...
      class="fixed inset-0 z-30 bg-black/35 dark:bg-black/55 lg:hidden"
    ...
    <aside
      v-if="showSidebar"
      :class="[
        'fixed inset-y-3 left-4 z-40 w-[min(18rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-border bg-sidebar text-sidebar-foreground shadow-[0_24px_60px_rgba(15,20,17,0.18)] transition-[width,transform] duration-300 ease-out dark:shadow-[0_24px_70px_rgba(0,0,0,0.45)] lg:translate-x-0 lg:shadow-none',
